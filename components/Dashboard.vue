    ...
    <v-layout style="background-color: #265073; min-height: 100vh;">
      <v-main style="height:auto; width: auto;">
        ...
        <!-- HEADDER===================================================================== -->
          ...
          <v-col style="margin-left: 125px;">

            <v-row
              style="height: 550px; width: 1300px; align-items: top; background-color: #ECF4D6; justify-content: center;  border-radius: 50px; margin:40px  50px 40px 0px; padding: 20px;"  >
...
export default {
  ...
  methods: {
    ...
    async doSave() {
      ...
      const url = 'http://localhost:7001/temp?date=' + this.year + '-' + this.month + '-' + this.day + '&time=' + this.h25 + ':' + this.h24 + ':' + this.h23 + '&temp=' + this.value2 + '&hemi=' + this.value+'%&ph='+this.value3 
